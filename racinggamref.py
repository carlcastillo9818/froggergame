...
REFER TO THIS CODE IF YOU WANT TO SEE HOW A CLASS FOR A CHARACTER IN YOUR GAME
CAN BE MADE.  LIKE YOUR FROG FOR EXAMPLE (ALREADY CREATED) OR MAYBE A CAR (LIKE BELOW).
THE CLASS WILL INHERIT FROM SPRITE CLASS SO IT CAN GET ALL THOSE METHODS AND FIELDS TO USE.
USE THIS PROGRAM TO REFERENCE IN YOUR OWN GAMES.
'''
